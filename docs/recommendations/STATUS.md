...
| T2 `{code, message}` error envelope | ○ | Phase 10.1 |
| T3 Chart memoisation + skeletons | ◐ | skeletons in 10a (`Card.tsx`); memoisation open |
| T4 Global "attended only" lens | ✅ | filter lens (Phase 8) |
| T5 Connector parse fixtures | ○ | Phase 10.1, FreqBlog first |
...
| 1.3 | Frontend tests | ✅ vitest (42 tests) |
...
| 2.2.7 | Setlist.fm | ✗ |
| 2.2.8 | Artist family tree | ○ Phase 10.3 next |
