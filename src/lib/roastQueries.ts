...
export async function roastReceipts(heat: Heat = 'medium', seed = 0): Promise<{ receipts: Receipt[]; facts: Record<string, unknown> }> {
  ...
  return { receipts: R.sort((a, b) => b.weight - a.weight).slice(0, 8), facts };
}
